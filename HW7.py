...
# Your name: Karlyle Yarema
# Your student id: 75198320
# Your email: kyarema@umich.edu
...
def position_birth_search(position, age, cur, conn):
    ...
    cur.execute('''SELECT name, position, birthyear FROM Positions JOIN Players ON Positions.id = Players.position_id 
                WHERE position = ? AND birthyear > ?''', (position, year,))
    tup_list = cur.fetchall()
